...
Parent is an exploratory project aiming to provide the common behaviour for custom parenting of processes. The word "exploratory" in the last sentence means that:

- This library has not been used in production (but it is motivated by real use cases I've seen).
- I'm not sure if the idea and/or implementation is sound.
- The interface is open to significant changes.

For these reasons, there's currently no documentation other than this readme. This is deliberate because things are still in the state of flux, and I might even end up abandoning the project. Therefore, any feedback is highly appreciated :-)

In this document I'll show the basic usage, and then I'll provide simplified solutions to a couple of problems which I've had in practice, and where I think that this library would have helped me.
